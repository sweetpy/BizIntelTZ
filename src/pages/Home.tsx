    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden" role="banner">
          ...
          <div className="absolute inset-0 opacity-10" aria-hidden="true">
            ...
            <div className="grid grid-cols-8 sm:grid-cols-12 gap-2 sm:gap-4 h-full p-4 sm:p-8">
              {[...Array(24)].map((_, i) => (
                <div key={i} className="bg-white/5 animate-pulse rounded-sm" style={{ animationDelay: `${i * 0.2}s` }}></div>
              ))}
            </div>
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="space-y-8 lg:space-y-10">
                <div className="space-y-6 lg:space-y-8">
                  <div className="flex items-center space-x-3 mb-6">
                    <div className="flex items-center space-x-2 bg-blue-600/20 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
                      <Shield className="h-4 w-4 sm:h-5 sm:w-5 text-blue-400 flex-shrink-0" />
                      <span className="text-blue-300 font-semibold text-sm sm:text-base">Enterprise Business Intelligence</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4" role="group" aria-label="Platform Statistics">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 hover:bg-white/15 transition-colors">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{realTimeMetrics?.totalBusinesses || '250,000+'}</div>
                    <div className="text-xs sm:text-sm text-slate-300">Verified Entities</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 hover:bg-white/15 transition-colors">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{realTimeMetrics?.uptime || '99.97%'}</div>
                    <div className="text-xs sm:text-sm text-slate-300">System Uptime</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 hover:bg-white/15 transition-colors">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{realTimeMetrics?.monthlyVerifications || '45,000+'}</div>
                    <div className="text-xs sm:text-sm text-slate-300">Monthly Verifications</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 hover:bg-white/15 transition-colors">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{realTimeMetrics?.responseTime || '< 200ms'}</div>
                    <div className="text-xs sm:text-sm text-slate-300">API Response</div>
                  </div>
                </div>
                ...
                <form onSubmit={handleSearch} className="mt-8" role="search">
                  <div className="relative group">
                    <Search className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 text-slate-400 flex-shrink-0" aria-hidden="true" />
                    <input
                      type="text"
                      placeholder="Search business entities, BI IDs, or sectors..."
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                      className="w-full pl-10 sm:pl-12 pr-24 sm:pr-32 py-3 sm:py-4 text-base sm:text-lg rounded-lg border border-slate-600 bg-white/10 backdrop-blur-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                      aria-label="Search business entities"
                    />
                    <button
                      type="submit"
                      className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors font-semibold focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm sm:text-base"
                      aria-label="Search"
                    >
                      Search
                    </button>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  <Link
                    to="/verify"
                    className="btn bg-blue-600 text-white hover:bg-blue-700 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold flex items-center justify-center space-x-2 transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  >
                  ...
                  <Link
                    to="/rankings"
                    className="btn bg-white/10 backdrop-blur-sm text-white border border-white/20 hover:bg-white/20 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold flex items-center justify-center space-x-2 transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white/40"
                  >
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 sm:p-8 border border-white/20 hover:bg-white/15 transition-colors">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg sm:text-xl font-bold text-white">Live Intelligence Dashboard</h3>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-xs sm:text-sm text-slate-300">Live</span>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center">
                          <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-400">{analytics?.views.toLocaleString() || '2.15M'}</div>
                          <div className="text-xs sm:text-sm text-slate-400">Monthly Queries</div>
                        </div>
                        <div className="text-center">
                          <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-400">{analytics?.clicks.toLocaleString() || '1.34M'}</div>
                          <div className="text-xs sm:text-sm text-slate-400">Verifications</div>
                        </div>
                      </div>
                  ...
                  <div className="pt-4 border-t border-white/10">
                    <Link
                      to="/admin"
                      className="w-full btn bg-blue-600/20 text-blue-300 hover:bg-blue-600/30 border border-blue-500/30 transition-all focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm sm:text-base"
                    >
        ...
        <div className="space-y-16 sm:space-y-20 lg:space-y-24">
          {/* TRUST INDICATORS */}
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20" role="region" aria-label="Trusted Organizations">
            <div className="text-center mb-12 lg:mb-16">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">Trusted by Leading Organizations</h2>
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto">Powering business intelligence for banks, corporations, and government agencies</p>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 items-center justify-items-center mb-12 lg:mb-16">
              {[
                ...
                <div key={index} className="bg-gray-100 hover:bg-gray-200 transition-colors rounded-lg p-4 sm:p-6 w-full h-16 sm:h-20 flex items-center justify-center group">
                  <span className="text-gray-600 group-hover:text-gray-800 font-semibold transition-colors text-sm sm:text-base">{org.name}</span>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
              {[
                ...
                <div key={index} className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                  <div className="font-bold text-gray-900 text-sm sm:text-base">{badge.label}</div>
                  <div className="text-xs sm:text-sm text-gray-600">{badge.desc}</div>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="bg-slate-50 py-16 sm:py-20" role="region" aria-label="BI ID Verification System">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div className="space-y-6 sm:space-y-8">
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Business Intelligence ID System</h2>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    {[
                      ...
                      <div key={index} className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                        <div className="flex items-center space-x-3 mb-3 sm:mb-4">
                          <feature.icon className={`h-5 w-5 sm:h-6 sm:w-6 text-${feature.color}-600 flex-shrink-0`} />
                  ...
                  <div className="pt-4 sm:pt-6">
                    <Link
                      to="/verify"
                      className="btn btn-primary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 flex items-center space-x-2 w-fit hover:scale-105 transition-transform focus:outline-none focus:ring-2 focus:ring-blue-400"
                    >
                ...
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200">
                  <div className="space-y-6">
                    <div className="text-center">
                      <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Sample BI ID Verification</h3>
                      <div className="bg-blue-50 rounded-lg p-4 sm:p-6 border-2 border-blue-200">
                        ...
                        <div className="text-xl sm:text-2xl font-mono font-bold text-blue-900 mb-4">BIZ-TZ-20241201-0001</div>
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={index} className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                          <span className="text-gray-700 font-medium text-sm sm:text-base">{metric.label}</span>
                          <span className={`text-${metric.color}-600 font-semibold text-sm sm:text-base`}>{metric.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          {leaderboardData && (
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20" role="region" aria-label="Market Intelligence Rankings">
              <div className="text-center mb-12 lg:mb-16">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">Market Intelligence & Rankings</h2>
                  ...
                  <div className="card border border-gray-200">
                    <div className="p-6 sm:p-8">
                      <div className="flex items-center justify-between mb-6 sm:mb-8">
                        <h3 className="text-xl sm:text-2xl font-bold text-gray-900 flex items-center space-x-3">
                          <Trophy className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 flex-shrink-0" />
                      ...
                      <div className="space-y-4">
                        {isLoading ? (
                          [...Array(5)].map((_, index) => (
                            <div key={index} className="p-4 sm:p-6 bg-gray-50 rounded-xl animate-pulse">
                          ...
                          leaderboardData.overall_leaders.slice(0, 5).map((business, index) => (
                            <div
                              key={business.id}
                              className={`flex items-center justify-between p-4 sm:p-6 rounded-xl border transition-all hover:shadow-md ${
                                index === 0 
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center space-x-2 sm:space-x-3 mb-1">
                                    <Link
                                      ...
                                      className="font-bold text-base sm:text-lg text-gray-900 hover:text-blue-600 transition-colors focus:outline-none focus:text-blue-600 truncate"
                                    >
                                      {business.name}
                                    </Link>
                                    {business.verified && (
                                      <ShieldCheck className="h-3 w-3 sm:h-4 sm:w-4 text-green-600 flex-shrink-0" aria-label="Verified" />
                                    )}
                                  </div>
                                  <div className="flex items-center space-x-2 sm:space-x-4 text-xs sm:text-sm text-gray-600">
                                    ...
                                    <span className="hidden sm:inline text-xs font-mono">BI ID: {business.bi_id}</span>
                                  </div>
                                </div>
                              </div>
                              
                              <div className="flex items-center space-x-3 sm:space-x-6 flex-shrink-0 ml-4">
                                <div className="text-center">
                                  <div className="text-lg sm:text-xl font-bold text-blue-600">{business.digital_score}</div>
                                  <div className="text-xs text-gray-600">Intelligence Score</div>
                                </div>
                                <div className="text-center hidden sm:block">
                                  <div className="text-base sm:text-lg font-semibold text-gray-900">{business.market_share_percentage}%</div>
                                  <div className="text-xs text-gray-600">Market Share</div>
                                </div>
                                <div className="text-center">
                                  <div className={`text-base sm:text-lg font-semibold flex items-center space-x-1 ${
                                    business.growth_rate > 0 ? 'text-green-600' : 'text-red-600'
                                  }`}>
                                    {business.growth_rate > 0 && <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />}
                        ...
                        {[
                          ...
                          <div key={index} className="flex items-center justify-between">
                            ...
                            <span className={`text-${metric.color}-600 font-semibold flex items-center space-x-1 text-sm`}>
                              {metric.icon && <metric.icon className="h-4 w-4 flex-shrink-0" />}
          ...
          {/* ENTERPRISE FEATURES */}
          <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 sm:py-20" role="region" aria-label="Enterprise Features">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12 lg:mb-16">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6">Enterprise-Grade Features</h2>
                ...
                {[
                  ...
                  <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 sm:p-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
                    <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                      <div className={`p-2 sm:p-3 bg-${feature.color}-500/20 rounded-lg flex-shrink-0`}>
                    ...
                    <p className="text-slate-300 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">{feature.description}</p>
          ...
          {/* CALL TO ACTION */}
          <section className="bg-gradient-to-r from-blue-600 to-indigo-700 py-16 sm:py-20" role="region" aria-label="Call to Action">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
                  <Link
                    to="/create-business"
                    className="btn bg-white text-blue-600 hover:bg-gray-100 text-lg sm:text-xl px-8 sm:px-12 py-3 sm:py-4 shadow-lg hover:shadow-xl font-semibold hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-white/40"
                  >
                    Request Enterprise Access
                  </Link>
                  <Link
                    to="/verify"
                    className="btn bg-blue-500/20 backdrop-blur-sm text-white border border-white/20 hover:bg-white/20 text-lg sm:text-xl px-8 sm:px-12 py-3 sm:py-4 shadow-lg hover:shadow-xl font-semibold hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-white/40"
                  >
                    Verify Business ID
                  </Link>
                </div>
                
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-5xl mx-auto mt-12 lg:mt-16">
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-white mb-2">250,000+</div>
                    <div className="text-blue-200 text-sm sm:text-base">Verified Entities</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-white mb-2">99.97%</div>
                    <div className="text-blue-200 text-sm sm:text-base">System Uptime</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-white mb-2">{"< 200ms"}</div>
                    <div className="text-blue-200 text-sm sm:text-base">API Response</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-white mb-2">31</div>
                    <div className="text-blue-200 text-sm sm:text-base">Regions Covered</div>
                  </div>
                </div>
              </div>
            </div>
